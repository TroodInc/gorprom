    ...
    return (
      <div {...{
        ...
        {label &&
          <label
            className={classNames(
              labelPosition === LABEL_POSITION_TYPES.right ? styles.labelRight : styles.labelLeft,
              labelClassName,
        ...
        {secondLabel &&
          <label
            className={classNames(
              secondLabelPosition === LABEL_POSITION_TYPES.right ? styles.labelRight : styles.labelLeft,
              labelClassName,
              disabled && styles.disabledLabel,
              disabled && disabledLabelClassName,
            )}
